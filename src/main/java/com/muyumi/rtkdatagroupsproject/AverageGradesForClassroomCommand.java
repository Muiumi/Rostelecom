...
//        Для вычисления средней оценки в 10 и 11 классах, воспользуемся группировкой учеников по номеру класса, затем последовательн,т.е. со сложностью O(n), 
//        у каждой персоны указанного класса достаём значение средней арифмитической его оценок
        double markSumm10 = 0,
                markSumm11 = 0;
